...
function TruncatedText({ text, maxLength, truncationIndicator }) {
    if (text.length <= maxLength) {
        return <p className='text-sm text-gray-600 mt-5'>{text}</p>;
    } else {
        const truncated = text.slice(0, maxLength - truncationIndicator.length) + truncationIndicator;
        return <p className='text-sm text-gray-600 mt-5' title={text}>{truncated}</p>;
    }
}
                ...
                <div className='w-4/5'>
                    ...
                    <div className='grid sm:grid-cols-2 gap-5 mb-10'>
                        <div>
                            ...
                            <a target='_blank' href='https://tuoitre.vn/oppenheimer-va-dong-phim-quan-trong-bac-nhat-the-ky-20230816090837524.htm' className='hover:text-blue-600 duration-300 font-medium'>Oppenheimer và dòng phim quan trọng bậc nhất thế kỷ</a>
                        ...
                        <div>
                            ...
                            <a target='_blank' href='https://gamek.vn/danh-gia-blue-beetle-sieu-anh-hung-dau-tien-cua-dong-phim-dcu-moi-178230818125129427.chn' className='hover:text-blue-600 duration-300 font-medium'>Blue Beetle - siêu anh hùng đầu tiên của dòng phim DCU mới</a>
                    ...
                    <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-5'>
                        <div>
                            ...
                            <a target='_blank' href='https://tuoitre.vn/thai-lan-khai-truong-rap-phim-dau-tien-danh-cho-thu-cung-20230610180945085.htm#:~:text=Theo%20H%C3%A3ng%20tin%20AFP%2C%20chu%E1%BB%97i,v%E1%BB%9Bi%20th%C3%BA%20c%C6%B0ng%20c%E1%BB%A7a%20m%C3%ACnh.' className='hover:text-blue-600 duration-300 font-medium'>Thái Lan khai trương rạp phim đầu tiên dành cho thú cưng</a>
                        ...
                        <div>
                            ...
                            <a target='_blank' href='https://cuoi.tuoitre.vn/bom-tan-cua-than-sam-chris-hemsworth-khong-the-nhap-canh-malaysia-vi-canh-nude-20220801182815466.htm' className='hover:text-blue-600 duration-300 font-medium'>Bom tấn của 'thần Sấm' Chris Hemsworth không thể ‘nhập cảnh’ Malaysia vì... cảnh nude</a>
                        ...
                        <div>
                            ...
                            <a target='_blank' href='https://vanhoavaphattrien.vn/uoc-nguyen-10-nam-bo-phim-tai-hien-mot-chuyen-tinh-dam-nuoc-mat-a20127.html' className='hover:text-blue-600 duration-300 font-medium'>“Ước nguyện 10 năm” – Bộ phim tái hiện một chuyện tình đẫm nước mắt</a>
