        ...
        return data?.danhSachGhe.map((seat) => {
            if (seat.daDat) {
                if (seat.taiKhoanNguoiDat === userLogin?.taiKhoan) {
                    return (
                        <button key={seat.stt} disabled={true} className='w-10 h-10 bg-yellow-600 text-white font-medium rounded-lg hover:scale-105 duration-300 border border-gray-300'>{seat.tenGhe}</button>
                    )
                }
                else {
                    return (
                        <button key={seat.stt} disabled={true} className='w-10 h-10 bg-red-600 text-white font-medium rounded-lg hover:scale-105 duration-300 border border-gray-300'>{seat.tenGhe}</button>
                    )
                }
            }
            else {
                ...
                <div className='w-full lg:w-2/3'>
                    <div className='mb-5'>
                        ...
                        <div className='bg-white rounded-md flex flex-wrap gap-3 p-5 border border-gray-500'>
                            ...
                            <div className='flex gap-1 items-center'>
                                <button className='w-6 h-6 rounded-md border-2 border-white bg-yellow-600'></button>
